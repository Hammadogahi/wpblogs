...
export default function PostCard () {
    return (
        <div className={styles.postCardWrapper}>
            ...
            <div className={styles.PostCardCenteredImage}>
                <Image className={styles.postCardImage} src="/img/sample-img-two.jpg" fill={true} alt="Sample Image" />
            </div>
            </div>
            <div className={styles.postCardContentWrapper}>
                <h2 className={styles.postCardHeadingCentered}>Matic Robot Vacuum Collects Dust but Not Your Personal Data</h2>
